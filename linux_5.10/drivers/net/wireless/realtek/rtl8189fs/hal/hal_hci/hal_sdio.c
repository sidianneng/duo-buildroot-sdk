...
bool sdio_power_on_check(PADAPTER padapter) {
	...
	RTW_INFO("xiongjian offset:0x%08x 0x%08x 0x%08x 0x%08x\n", val_offset0, val_offset1, val_offset2, val_offset3);

	u32 test_val = rtw_read16(padapter, REG_CR);
	RTW_INFO("xiongjian test_val:0x%08x\n");
